...
census. Every recovered TAR member records its archive offset, size and SHA-256.
"""
...
def main() -> int:
    ...
    for pass_index in range(a.max_passes):
        ...
        found, headers = archive.find(wanted)
    ...
    # The final census is the authoritative output of this recursive driver.
    ...
    report = {
        ...
        'policy': (
            ...
            'it does not establish semantic world/entity ownership.'
        ),
    }
