...
SHAS={
 '8108E953':'fd7d50fd29075fe0ff978bf3001976021f7837f77bd310e4e470f0e6547b3054',
 '8108E955':'b1db9f70cf55329bb63883a06083800b5df438986d59b4de6ae2d0b9ca0b55f0',
 '8108E956':'af54f53ddeca2f42ebca4294439136c176a33d86c206d1923decc51c9c5caf3f',
}
MATERIALS={
...
REQ={
 ...
 '8108E955':{
  ...
  'B':({'0':[10,11,12,13,16,17,22,23,26,27,48,54,56],'12':[28,29,30],'13':[6,7]},[('0','x'),('1','w'),('1','x'),('2','w'),('2','x'),('4','w'),('4','x')]),
 },
}
# Correct B texture channels independently from typo-prone human transcription.
REQ['8108E955']['B']=(REQ['8108E955']['B'][0],[('0','x'),('1','w'),('1','z'),('2','w'),('2','z'),('4','w'),('4','z')])
