...
EXPECTED_VS={
 'a5ad940fbf21746563f6585b889ac91b4220c94a3559e768028c894454bcdc12':('D1_XUR_VS_A5AD940F_DATAFLOW_SEMANTICS_EXACT','dual_quaternion'),
 'b045462d7896e5c5012e8587076f6c669455b35009c197cd1c50d4e7529a1ab6':('D1_XUR_VS_80876960_TWO_INFLUENCE_DQ_EXACT','dual_quaternion'),
 '24392dbd8f217a832456372a8d9c24d3ef365ab5a0b8bcd362882ca845052964':('D1_XUR_VS_24392DBD_FOUR_INFLUENCE_DQ_EXACT','dual_quaternion'),
 'e6f18138e330a9c6b3ddce2e71890b1bcda73f732c4f6007b4c788c0ff62f4c0':('D1_VEX_80AAE149_VERTEX_INTERFACE_EXACT','rigid_three_row_palette'),
}
def main()->int:
 ...
 for sha,(status,semantic_substring) in EXPECTED_VS.items():
  e=by.get(sha)
  ...
  if semantic_substring not in str(e.get('semantic_class','')):v.append(f'wrong_semantic_class:{sha}:{e.get("semantic_class")}')
