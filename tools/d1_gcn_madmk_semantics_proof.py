...
def main() -> int:
    ...
    out={'schema_version':1,'status':'D1_GCN_V_MADMK_F32_SEMANTICS_SOURCE_PROVEN' if sem and not viol else 'D1_GCN_V_MADMK_F32_SEMANTICS_PARTIAL','semantics':sem,'violations':viol,'policy':'Only literal v_madmk_f32 semantics from the immutable upstream AMDGPU implementation are promoted; no Destiny visual role is inferred.'}
